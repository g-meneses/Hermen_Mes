...
<head>
    ...
    <style>
        ...
        * {
        ...
        .sidebar-user {
            flex-shrink: 0;
            position: static; /* Cambiar de sticky a static */
        }
    </style>
</head>
<body>
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="#" class="menu-link"><i class="fas fa-check-circle"></i><span class="menu-text">Prod. Terminados</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                                <li><a href="#" class="menu-link"><i class="fas fa-wrench"></i><span class="menu-text">Repuestos</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="#" class="menu-link"><i class="fas fa-flask"></i><span class="menu-text">Recetas (BOM)</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                                ...
                                <li><a href="#" class="menu-link"><i class="fas fa-calendar-week"></i><span class="menu-text">Plan Semanal</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="menu-item">
                                    ...
                                    <ul class="submenu">
                                        <li><a href="#" class="menu-link"><i class="fas fa-clipboard"></i><span class="menu-text">Órdenes</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                                        <li><a href="#" class="menu-link"><i class="fas fa-clock"></i><span class="menu-text">Por Turno</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                                        <li><a href="#" class="menu-link"><i class="fas fa-route"></i><span class="menu-text">Control</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                                        <li><a href="#" class="menu-link"><i class="fas fa-chart-line"></i><span class="menu-text">Reportes</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                                    </ul>
                                </li>
                                <!-- Algodón -->
                                <li class="menu-item">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a href="<?php echo SITE_URL; ?>/modules/tejido/insumos.php" class="menu-link <?php echo $currentPage === 'insumos' ? 'active' : ''; ?>"><i class="fas fa-cube"></i><span class="menu-text">Insumos</span></a></li>
                                <li><a href="#" class="menu-link"><i class="fas fa-users"></i><span class="menu-text">Personal</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    ...
                    <ul class="submenu">
                        <li><a href="#" class="menu-link"><i class="fas fa-users-cog"></i><span class="menu-text">Usuarios</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                        <li><a href="#" class="menu-link"><i class="fas fa-cog"></i><span class="menu-text">Configuración</span><span class="menu-badge badge-soon">Pronto</span></a></li>
                    </ul>
                </li>
            </ul>
