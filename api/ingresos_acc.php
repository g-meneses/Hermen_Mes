<?php
/**
 * API para Gestión de Ingresos - Accesorios (ACC)
 * ID de Inventario: 4
 */
...
try {
    ...
    switch ($method) {
        case 'GET':
            ...
            switch ($action) {
                ...
                case 'siguiente_numero':
                    ...
                    $url = "obtener_siguiente_numero.php?tipo_inventario=4&operacion=INGRESO&tipo_movimiento={$tipo}&modo=preview";
        ...
        case 'POST':
            ...
            switch ($action) {
                case 'crear':
                    $tipoIngreso = $input['id_tipo_ingreso'] ?? null;
                    ...
                    try {
                        ...
                        $db->commit();
                        echo json_encode(['success' => true, 'message' => "Ingreso ACC $numeroDoc registrado"]);
