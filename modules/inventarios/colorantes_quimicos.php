<?php
/**
 * Módulo de Inventarios - Colorantes y Auxiliares Químicos
 * Sistema MES Hermen Ltda. v1.0
 * Página independiente para gestión completa de Colorantes y Aux. Químicos
 */
...
$pageTitle = 'Colorantes y Aux. Químicos - Inventarios';
$currentPage = 'colorantes_quimicos';

$db = getDB();
$stmt = $db->prepare("SELECT * FROM tipos_inventario WHERE codigo = 'CAQ' AND activo = 1");
$stmt->execute();
$tipoInventario = $stmt->fetch(PDO::FETCH_ASSOC);
if (!$tipoInventario) {
    die('Error: Tipo de inventario "Colorantes y Aux. Químicos" no encontrado');
}

$tipoId = $tipoInventario['id_tipo_inventario'];
$tipoColor = $tipoInventario['color'] ?? '#6f42c1';
    ...
    <div class="mp-header">
        <div class="mp-header-left">
            ...
            <div class="mp-title">
                ...
                <div>
                    <h1>Colorantes y Aux. Químicos</h1>
                    <p>Gestión de inventario de colorantes y auxiliares químicos</p>
                </div>
            </div>
        </div>
...
<div class="modal" id="modalIngreso">
    <div class="modal-content xlarge">
        <div class="modal-header">
            <h3><i class="fas fa-arrow-down"></i> Ingreso de Colorantes y Aux. Químicos</h3>
...
<div class="modal" id="modalSalida">
    <div class="modal-content large">
        <div class="modal-header">
            <h3><i class="fas fa-arrow-up"></i> Salida de Colorantes y Aux. Químicos</h3>
