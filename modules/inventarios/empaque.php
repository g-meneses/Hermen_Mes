...
<div class="modal" id="modalItem">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-box"></i> <span id="modalItemTitulo">Nuevo Item de Empaque</span></h3>
                    ...
                    <div class="form-group">
                        ...
                        <div id="codigoAutomaticoView" style="display:block;">
                            ...
                            <small class="text-muted" id="formatoSugerido"
                                ...
                                Formato: EMP-CAT-SUBCAT-XXX
                            </small>
                            <!-- BANNER DE ESTADO DE CÓDIGO -->
                        ...
                        <div id="codigoPreviewSection"
                            ...
                            <div style="display:flex; gap:5px; align-items:center; justify-content:center; flex-wrap:wrap;">
                                <span class="badge badge-secondary" id="labelTipo">EMP</span>
