...
<div class="modal" id="modalItem">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-box"></i> <span id="modalItemTitulo">Nuevo Item de Accesorio</span></h3>
                    ...
                    <div class="form-group">
                        ...
                        <div id="codigoPreviewSection"
                            ...
                            <div
                                ...
                                <span class="badge badge-secondary" id="labelTipo">ACC</span>
        ...
        <div class="modal-body">
            ...
            <div id="seccionFactura" class="d-none" style="margin-bottom: 15px;">
                <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="ingresoConFactura" style="font-weight:600; color:#28a745;">
