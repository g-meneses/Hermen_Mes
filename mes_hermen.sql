...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-01-2026 a las 02:53:56
...
--
-- Estructura de tabla para la tabla `backup_detalles_20260109`
--

CREATE TABLE `backup_detalles_20260109` (
...
--
-- Estructura de tabla para la tabla `backup_documentos_20260109`
--

CREATE TABLE `backup_documentos_20260109` (
  `id_documento` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `backup_inventarios_20260109`
--

CREATE TABLE `backup_inventarios_20260109` (
...
--
-- Estructura de tabla para la tabla `backup_movimientos_20260109`
--

CREATE TABLE `backup_movimientos_20260109` (
  ...
  `costo_promedio_anterior` decimal(18,6) DEFAULT NULL,
  `costo_promedio_posterior` decimal(18,6) DEFAULT NULL,
...
CREATE TRIGGER `trg_movimiento_codigo` BEFORE INSERT ON `movimientos_inventario` FOR EACH ROW BEGIN
        ...
        WHERE codigo_movimiento COLLATE utf8mb4_unicode_ci LIKE CONCAT('MOV-', fecha_str, '%') COLLATE utf8mb4_unicode_ci;
