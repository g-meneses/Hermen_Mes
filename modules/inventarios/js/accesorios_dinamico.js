...
document.addEventListener('DOMContentLoaded', function () {
    console.log('ðŸš€ Inicializando mÃ³dulo de Accesorios de ConfecciÃ³n...');
...
async function obtenerSiguienteNumero(tipo = null) {
    ...
    try {
        ...
        const url = ${BASE_URL_API}/ingresos_acc.php?action=siguiente_numero&tipo=;
...
function ejecutarFallbackLocalIngreso(tipo, motivo) {
    ...
    const numero = 'IN-ACC-' + movCode + '-' + fechaStr + '-' + rand;
    numerosDocumentoCache[tipo] = numero;
    docInput.value = numero;
    docInput.disabled = false;
    console.warn('Fallback IN ACC:', numero);
}
