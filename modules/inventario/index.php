...
async function cargarInventario(tipo) {
    try {
        const response = await fetch(`${baseUrl}/api/inventario.php?action=por_tipo&tipo=${tipo}`);
        const data = await response.json();
...
async function cargarMovimientos() {
    try {
        ...
        const response = await fetch(`${baseUrl}/api/inventario.php?${params}`);
        const data = await response.json();
...
async function verificarStock() {
    ...
    try {
        const response = await fetch(`${baseUrl}/api/inventario.php?action=stock_producto&id_producto=${idProducto}`);
        const data = await response.json();
...
async function guardarMovimiento() {
    ...
    try {
        const response = await fetch(`${baseUrl}/api/inventario.php`, {
            method: 'POST',
            headers: {
