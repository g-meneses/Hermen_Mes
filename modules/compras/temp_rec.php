                            ...
                            <table class="w-full text-sm">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th class="py-3 px-4 text-center">Cant. OC</th>
                                        <th class="py-3 px-4 text-center text-primary"
                                            title="Cantidad ajustada según Documento de Embarque">Cant. Packing</th>
                                        <th class="py-3 px-4 text-center">Pendiente</th>
                                        <th
                                            class="py-3 px-4 text-left w-32 bg-emerald-50 text-emerald-800 rounded-t-lg">
                                            A Recibir (Físico)</th>
