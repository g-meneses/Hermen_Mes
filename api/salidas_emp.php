<?php
/**
 * API de Salidas de Material de Empaque (EMP)
...
try {
            ...
            switch ($action) {
                ...
                case 'ingresos_devolucion':
                    ...
                    $stmt = $db->prepare("
                        ...
                        LIMIT 50
                    ");
                    $stmt->execute([$TIPO_INVENTARIO_EMP]);
    ...
    error_log("Error en salidas_emp.php: " . $e->getMessage());
    ob_clean();
    echo json_encode([
        'success' => false,
