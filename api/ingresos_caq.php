<?php
/**
 * API de Ingresos de Colorantes y Auxiliares Químicos
...
try {
        ...
        case 'GET':
            ...
            switch ($action) {
                ...
                case 'resumen':
                    ...
                    ");
                    $stmt->execute([$TIPO_INVENTARIO_CAQ, $mes, $anio]);
                ...
                case 'categorias':
                    ...
                    ");
                    $stmt->execute([$TIPO_INVENTARIO_CAQ]);
    ...
    error_log("Error en ingresos_caq.php: " . $e->getMessage());
    ob_clean();
    echo json_encode([
        'success' => false,
